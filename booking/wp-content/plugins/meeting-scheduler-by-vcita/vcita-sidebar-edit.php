...
<div class="vcita-wrap wide">
	...
	<script type="text/html" id="iframe-template">
		<iframe src="https://<?php echo VCITA_SERVER_BASE ?>/widget_implementations?platform=wordpress&widget=sidebar&key=<?php echo $key ?>" width="100%" height="100%"/>
	</script>
	<?php } else { ?>
	<script type="text/javascript">	
		jQuery(function ($) {	

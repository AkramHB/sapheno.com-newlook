...
// ***************************************************************************** Begin help defaults.
    ...
    define('DOPBSP_CONFIG_HELP_DOCUMENTATION_URL', 'https://pinpoint.world/wordpress/documentation?utm_source=WordPress&utm_medium=Plugin%20FREE'); // Link to plugin documentation.

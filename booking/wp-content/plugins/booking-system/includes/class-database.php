...
// Update
		 ...
		 */
		    ...
		    $control_data = $wpdb->query('SHOW TABLES LIKE "'.$DOPBSP->tables->settings.'"');
                    ...
                    if ($wpdb->num_rows > 0){
                        $wpdb->query('ALTER TABLE '.$DOPBSP->tables->settings.' CHANGE unique_key name VARCHAR(128)');
		    ...
		    $control_data = $wpdb->query('SHOW TABLES LIKE "'.$DOPBSP->tables->settings_calendar.'"');
                    ...
                    if ($wpdb->num_rows > 0){
                        $wpdb->query('ALTER TABLE '.$DOPBSP->tables->settings_calendar.' CHANGE unique_key name VARCHAR(128)');
		    ...
		    $control_data = $wpdb->query('SHOW TABLES LIKE "'.$DOPBSP->tables->settings_notifications.'"');
                    ...
                    if ($wpdb->num_rows > 0){
                        $wpdb->query('ALTER TABLE '.$DOPBSP->tables->settings_notifications.' CHANGE unique_key name VARCHAR(128)');
		    ...
		    $control_data = $wpdb->query('SHOW TABLES LIKE "'.$DOPBSP->tables->settings_payment.'"');
                    ...
                    if ($wpdb->num_rows > 0){
                        $wpdb->query('ALTER TABLE '.$DOPBSP->tables->settings_payment.' CHANGE unique_key name VARCHAR(128)');
		    ...
		    $control_data = $wpdb->query('SHOW TABLES LIKE "'.$DOPBSP->tables->settings_search.'"');
                    ...
                    if ($wpdb->num_rows > 0){
                        $wpdb->query('ALTER TABLE '.$DOPBSP->tables->settings_search.' CHANGE unique_key name VARCHAR(128)');

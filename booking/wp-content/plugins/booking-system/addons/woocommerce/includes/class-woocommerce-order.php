                        ...
                        foreach ($reservations_data as $reservation_data){
                            $DOPBSP->classes->backend_reservation->add($reservation_data->calendar_id,
                                                                       ...
                                                                       array(
                                                                            ...
                                                                            array("id" => 5, "is_email" => "false", "add_to_day_hour_info" => "false", "add_to_day_hour_body" => "false","translation" => $DOPBSP->text('FORMS_DEFAULT_MESSAGE'), "value" => $order->customer_message)
                                                                       ),
                                                                       '',
                                                                       '',
                                                                       'woocommerce',

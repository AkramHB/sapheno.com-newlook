...
echo'	<form name="f" method="post" action="">
			...
			<div class="mo_registration_divided_layout">
				<div class="mo_registration_table_layout">
					<h3>'.mo_("Login with miniOrange").'</h3>
					<p><b>'.mo_("It seems you already have an account with miniOrange. Please enter your miniOrange email and password.").'</td><a href="#forgot_password"> '.mo_("Click here if you forgot your password?").'</a></b></p>

...
class CountryList
{
    ...
    {
        return !MoUtility::isBlank(get_mo_option('mo_customer_validation_default_country_code'))
                    ? get_mo_option('mo_customer_validation_default_country_code') : null;
    }

    public static function isCountrySelected_deprecated($value)
    {
        return !MoUtility::isBlank(get_mo_option('mo_customer_validation_default_country_code'))
                    && $value == get_mo_option('mo_customer_validation_default_country_code');
	}

	public static function getDefaultCountryData() 
	{
		return !MoUtility::isBlank(get_mo_option('mo_customer_validation_default_country')) 
					? maybe_unserialize(get_mo_option('mo_customer_validation_default_country')) : null;
	}

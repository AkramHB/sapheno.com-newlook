...
function change_captcha_digit(digit) {
	...
	if (document.getElementById('captcha_digit').value) {	
		...
		captcha.setAttribute("src", url_for_ajax + "?action=formmakerwdcaptcha_fmc&digit="+digit+"&i=form_id_temp");
		...
		captcha.setAttribute("src", url_for_ajax+"?action=formmakerwdcaptcha_fmc&digit=6&i=form_id_temp");

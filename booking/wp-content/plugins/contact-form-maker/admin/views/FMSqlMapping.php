...
class FMViewFormMakerSQLMapping_fmc {
              ...
              <div class="struct">
                <div class="cols">
                    ...
                    foreach ( $table_struct as $key => $col ) {
                      ...
                      <div>
                        <label title="<?php echo $title; ?>" class="hasTip"><b><?php echo $col->Field; ?></b>
                          <img src="<?php echo WDCFM()->plugin_url . '/images/info.png?ver=' . WDCFM()->plugin_version . ''; ?>" style="width:20px; vertical-align:middle;padding-left: 10px;" />
                        </label>
                  ...
                  if ( $con_method == 'delete' or $con_method == 'update' ) {
                    echo '<div class="select-db-op where"><img src="' . WDCFM()->plugin_url . '/images/add_condition.png?ver=' . WDCFM()->plugin_version . '" title="ADD" class="add_cond"/>WHERE</div>';
                    if ( $wheres ) {
                      echo '<script>';
  ...
  public function add_query( $params ) {
    $label = $params['label'];
    $form_id = $params['form_id'];
    $filter_types = array(
      "type_submit_reset",
  ...
  public function db_table_struct( $params ) {
    $label = $params['label'];
    $form_id = $params['form_id'];

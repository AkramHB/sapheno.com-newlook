...
class FMViewUninstall_fmc {
  ...
  public function display( $params ) {
    ...
    ?>
    <form method="post" action="admin.php?page=uninstall<?php echo WDCFM()->menu_postfix; ?>" style="width:95%;">
  ...
  public function uninstall( $params ) {
    ...
    $deactivate_url = add_query_arg(array(
                                      'action' => 'deactivate',
                                      'plugin' => WDCFM()->main_file,
                                    ), admin_url('plugins.php'));
    $deactivate_url = wp_nonce_url($deactivate_url, 'deactivate-plugin_' . WDCFM()->main_file);
    ?>

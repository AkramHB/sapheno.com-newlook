...
class FMViewSelect_data_from_db_fmc {
      ...
      function connect() {
        ...
        jQuery.ajax({
          ...
          url: "<?php echo add_query_arg(array(
                                           'action' => 'select_data_from_db' . WDCFM()->plugin_postfix,
                                           'form_id' => $form_id,
  ...
  public function db_table_struct_select( $params ) {
    ...
    <script>
      ...
      function save_query() {
        str = '';
        plugin_url = '<?php echo WDCFM()->plugin_url; ?>';
        plugin_version = '<?php echo WDCFM()->plugin_version; ?>';
    ...
    <?php if ( $table_struct ): ?>
      <div class="cols">
        ...
        <div class="select-db-op where">
          <img src="<?php echo WDCFM()->plugin_url . '/images/add_condition.png?ver=' . WDCFM()->plugin_version . ''; ?>" title="ADD" class="add_cond" />WHERE
        </div>

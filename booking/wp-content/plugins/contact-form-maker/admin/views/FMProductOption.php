    ...
    <div id="fm-paypal-properties">
      ...
      <div class="fm-properties">
        ...
        <div>
          ...
          <img id="el_choices_add" src="<?php echo WDCFM()->plugin_url . '/images/add.png?ver=' . WDCFM()->plugin_version . ''; ?>" style="vertical-align:middle; cursor: pointer;" title="add" onclick="add_choise_option()" />
        </div>
    ...
    <script>
      ...
      function type_add_options(w_choices) {
        ...
        for (j = 0; j < n; j++) {
          ...
          el_choices_remove.setAttribute("src", '<?php echo WDCFM()->plugin_url . '/images/delete.png?ver=' . WDCFM()->plugin_version . ''; ?>');

...
class FMViewSelect_data_from_db {
  ...
  public function db_table_struct_select( $params ) {
    ...
    <script>
      ...
      function save_query() {
        str = '';
        plugin_url = '<?php echo WDFM()->plugin_url; ?>';
        plugin_version = '<?php echo WDFM()->plugin_version; ?>';
    ...
    <?php if ( $table_struct ): ?>
      <div class="cols">
        ...
        <div class="select-db-op where">
          <img src="<?php echo WDFM()->plugin_url . '/images/add_condition.png?ver=' . WDFM()->plugin_version . ''; ?>" title="ADD" class="add_cond" />WHERE
        </div>

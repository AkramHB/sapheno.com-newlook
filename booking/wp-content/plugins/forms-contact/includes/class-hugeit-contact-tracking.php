...
class Hugeit_Contact_Tracking
{
    /**
     * Hugeit_Contact_Tracking constructor.
     */
    public function __construct()
    {
        if (isset($_GET['hugeit_contact_tracking_opt_in'])) {
            add_action('admin_init', array($this, 'maybe_opt_in'));
        }

        add_action('admin_notices', array($this, 'admin_notice'));
        add_action('hugeit_contact_opt_in_cron', array($this, 'track_data'));
    }
    ...
    public function maybe_opt_in()
    {
        ...
        $opt_in_action = htmlspecialchars($_GET['hugeit_contact_tracking_opt_in']);
        ...
        header('Location: ' . admin_url('admin.php?page=hugeit_forms_main_page'));
    ...
    public function admin_notice()
    {
        ...
        if(!in_array($screen_id, $GLOBALS['hugeit_contact_admin_pages'])) return;
        ...
        echo Hugeit_Contact_Template_Loader::render(HG_CONTACT_PATH.'/admin/tracking/banner/show.php', compact('optin_url','optout_url'));
    }
    ...
    {
        return add_query_arg('hugeit_contact_tracking_opt_in', 1, admin_url('admin.php?page=hugeit_forms_main_page'));
    }
    ...
    {
        return add_query_arg('hugeit_contact_tracking_opt_in', 0, admin_url('admin.php?page=hugeit_forms_main_page'));
    }
    ...
    {
        return ('opted_in' === get_option('hugeit_contact_allow_tracking', false));
    }
    ...
    {
        return ('opted_out' === get_option('hugeit_contact_allow_tracking', false));
    }
    ...
    {
        update_option('hugeit_contact_allow_tracking', 'opted_in');
    }
    ...
    {
        update_option('hugeit_contact_allow_tracking', 'opted_out');
    }
    ...
    public function track_data()
    {
        ...
        $data["project_id"] = 15;
        $data["project_plan"] = 'free';
        $data["project_version"] = HG_CONTACT_VERSION;

...
<div class="free_version_banner" >
    <img class="manual_icon" src="<?php echo HG_IMAGES_BASE_URL; ?>/forms_icon.png" alt="user manual" />
    ...
    <img class="closer_icon_only" alt="Close Icon" src="<?php echo HG_IMAGES_BASE_URL; ?>/close_btn.png" />
    <a href="http://huge-it.com" target="_blank"><img class="huge_it_logo" src="<?php echo HG_IMAGES_BASE_URL; ?>/huge-it_logo.png"/></a>
    <div class="mobile_icon_show hide">
        <a href="http://huge-it.com" target="_blank"><img class="huge_it_logo_mobile" src="<?php echo HG_IMAGES_BASE_URL; ?>/logo_mobile_screen.png"/></a>
    </div>
    ...
    <div class="hg_view_plugins_block">
        <ul class="inline_menu">
            ...
            <li class="toggle_element">
                <a href="#">
                    <img class="toggle_icon" src="<?php echo HG_IMAGES_BASE_URL; ?>/toggle_icon.png"/>
                </a>
            </li>
        </ul>
